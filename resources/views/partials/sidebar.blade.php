        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Main</div> <i class="icon-menu" title="Main"></i></li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('employees.index')}}" class="nav-link {{ (request()->is('employees*')) ? 'nav-link active' : '' }}"><i class="icon-cube4"></i><span>Employees</span></a>
                    </li>
        
    
                    <li class="nav-item">
                        <a href="{{ route('companies.index')}}" class="nav-link {{ (request()->is('companies*')) ? 'nav-link active' : '' }}"><i class="icon-folder-plus"></i><span>Companies</span></a>
                    </li>
